define( [
  ...
  var dictionnary = {
    "command": [
      [ "advancement", [
          [ "test", "#player", "advancementName", "criterion" ],
          [ "*grant|revoke", "#player", "*everything|from|only|through|until", "advancementName", "criterion" ]
        ]
      ],
      ...
      [ "publish" ],
      [ "recipe", "*give|take", "#player", "*recipeName|*" ],
      [
        "replaceitem", [
